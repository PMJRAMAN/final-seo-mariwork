...
| DEC-039 | Breadcrumb structured-data policy across Store/Academy/content | DISCUSSING | current output + hierarchy | Use only where visible hierarchy is accurate |
