...
| DEC-067 | Redirect technical owner and implementation path | DISCUSSING | SEO-OWNERSHIP; legacy workstreams | Rank Math first where supported; platform only when justified |
