...
| ID | Decision | Status | Primary evidence | Blocking / notes |
|---|---|---|---|---|
| DEC-025 | Durable Product Category set and sitemap/index policy | DISCUSSING | SR-004 SR-ST-006; taxonomy reconciliation | Durable categories proposed indexable; migration categories 20/27 decommission candidates |
