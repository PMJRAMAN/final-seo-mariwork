...
| DEC-035 | Product variation ProductGroup/variant schema architecture | DISCUSSING | SR-004 SR-ST-004; variable-schema matrix | Canary required; Rank Math extension only if Free lacks capability |
