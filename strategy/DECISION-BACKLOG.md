...
| DEC-014 | Academy course/lesson title/H1 conventions | ACCEPTED | course + 37 lesson dossiers | Accepted: natural educational-unit titles; default Course H1 = Course SEO `<title>` and Lesson H1 = Lesson SEO `<title>`; remove repetitive `- رنگ پارچه ماری ورک` suffix; include Mariwork only when naturally part of subject/identity; preserve numeric sequence only when it reflects a genuine multi-part series; no URL changes from normalization; schema/video naming follows visible identity but ownership/eligibility remains DEC-037/038. |
...
| DEC-018 | Article meta-description update rule | ACCEPTED | current article output | Accepted: classify each Article meta as KEEP, SHORTEN/REFINE, REWRITE, or FACT-CHECK REQUIRED. Preserve accurate useful metas; no blanket rewrite; resolve duplicates; rewrite weak/generic/insufficient metas; refine introduction-like verbose metas; no fixed 150/160-character limit; summarize the Article rather than copy paragraph one; factual/historical/scientific/safety/technical claims requiring source validation escalate to DEC-023; metadata only, not substantive Article changes; cannibalization remains DEC-119. |
| DEC-019 | Academy course/lesson meta-description rule | DISCUSSING | current course/lesson output; owner clarification 2026-09-25 | REOPENED FOR AMENDMENT. Every Academy Lesson contains a video; Academy must be positioned as video-first practical/instructional content and differentiated from Magazine text/reference content. Revised policy must decide explicit video-format wording in SEO title/meta/visible context, keep metadata unique to each Lesson/video, and coordinate with DEC-024 and DEC-119 so Academy and Magazine do not target the same intent with substantially overlapping content. |
...
| DEC-022 | Static/trust page content policy | DISCUSSING | static dossiers | Decide what About/Why/Contact/Stores/FAQ should contain and what not to expand |
...
| DEC-024 | Academy lesson/course content standard | OPEN | education dossiers; DEC-019 owner clarification | Must encode Academy as video-first practical/instructional content: every Lesson has a primary video, visible context should make video format clear, and supporting text/transcript must complement rather than duplicate Magazine reference/editorial content. |
