...
| DEC-050 | Product vs Category vs Article query/content role boundary | DISCUSSING | CONTENT-ARCHITECTURE; SR-004 | Page+Query unavailable; use user intent + SERP research where needed |
