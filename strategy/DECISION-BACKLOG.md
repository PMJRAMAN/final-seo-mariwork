...
| DEC-056 | Product image/gallery SEO policy | DISCUSSING | Store evidence + MASTER-TODO L; owner clarification 2026-09-25 | Product-family image policy is under discussion. Owner-confirmed commercial rule: for Mariwork fabric-color Products, the primary Product image intentionally represents the 60 ml package/variant. This is a deliberate merchandising decision and must not be overridden by SEO merely to make the primary image variant-neutral. SEO/image policy must preserve that commercial choice while ensuring the page and gallery remain factually clear about the Product's available variants and do not misrepresent the purchasable Product. Remaining primary/gallery rules require visual review and further owner decisions. |
