...
| ID | Decision | Status | Primary evidence | Blocking / notes |
|---|---|---|---|---|
| DEC-007 | Product Title Naming Standard — fabric colors | DISCUSSING | SR-004 SR-ST-002; current-title-h1-matrix | Decide product type, color name, «ماری ورک», code, numeral/separator rules |
